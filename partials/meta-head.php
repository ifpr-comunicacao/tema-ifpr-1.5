...
function ifpr_opengraph(){
    ...
    $share_img = 'https://reitoria.ifpr.edu.br/wp-content/uploads/2019/08/ifpr-default.jpg';
    ...
    if( is_single() || is_page() ){
        ...
        if ( empty($share_img) ){ $share_img = 'https://reitoria.ifpr.edu.br/wp-content/uploads/2019/08/ifpr-default.jpg'; }
    }
