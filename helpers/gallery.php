...
function gallery_add_class ($content) {
    ...
    if( is_single() || is_page() ) {
        ...
        $carouselid = 'd-block carousel slide carouselPost" data-ride="carousel" data-interval="3000"';
        $replace = array(
            //old class                                //new class
            ...
            'wp-image-'                               => 'bd-highlight ifpr_gallery_img wp-image-',
            '</a><figcaption>'                        => '</a><figcaption class="blocks-gallery-item__caption carousel-caption d-md-block">'
        );
