...
<header class="container">
	<div class="row justify-content-between menu-row">
		...
		<a href="<?php echo $home_url; ?>" class="col-6 col-md-4 logo__link">
			...
			<svg id="logo_ifpr" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 230 54" role="img" aria-label="[title + description]">
		...
		<div id="busca" class="col-8 d-none d-md-block">
			...
			<p class="mb-0 text-right busca__link_sei"><?php _e( 'Procure', 'ifpr_theme' ); ?> <span class="font-weight-bold"><?php _e( 'documentos institucionais', 'ifpr_theme' ); ?></span> <?php _e('no', 'ifpr_theme'); ?> <a href="https://sei.ifpr.edu.br/sei/modulos/pesquisa/md_pesq_processo_pesquisar.php?acao_externa=protocolo_pesquisar&acao_origem_externa=protocolo_pesquisar&id_orgao_acesso_externo=0"><span class="badge badge-ifpr"><?php _e( 'SEI!', 'ifpr_theme' ); ?><i class="fas fa-external-link-alt"></i></span></a></p>
		</div>
		<!-- Fim Busca -->

		<?php
			//Nav dinâmico para /en-US /es-ES e /pt-BR
			$home_url = null;
				wp_nav_menu( 
					array(
					'container' => 'nav',
