...
<header class="container">
		...
		<a href="<?php echo $home_url; ?>" class="marca-ifpr">
			...
			<svg id="marca-ifpr" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 230 54" role="img" aria-label="[title + description]">
				...
				<text transform="matrix(1.0017 0 0 1 <?php echo $transformLine2; ?>)" class="st1">Paraná</text>
		...
		<div id="busca" class="header-busca">
			...
			<p class="busca__link_sei">Documentos institucionais estão no <a href="https://sei.ifpr.edu.br/sei/modulos/pesquisa/md_pesq_processo_pesquisar.php?acao_externa=protocolo_pesquisar&acao_origem_externa=protocolo_pesquisar&id_orgao_acesso_externo=0"> SEI!</a></p>
		</div>
		<!-- Fim Busca -->
