$(document).ready(function () {
	...
	//Abrir accordion 1 nivel do menu lateral esquerdo
	$(".menu-esq-title").click(function () {
		$(this).parent().toggleClass("open");
	});

	//Abrir accordion 2 nivel do menu lateral esquerdo
	...
	// Abrir o menu com o item da página atual
	$(".menu-esq").each(function () {
		if ($(this).find('li.current-menu-item').length) {
			$(this).addClass('open');
		}
	});

	// Semana do servidor Campus Foz do Iguaçu
...
//Smooth Scroll
$(document).ready(function () {
	// Add smooth scrolling to all links into navigation
...
const nav = document.querySelector(".menu-contextual-page")
const itens = nav.getElementsByClassName("page_item");
const quant = itens.length;
if(quant > 5){
	document.querySelector('.menu-contextual-toggle').className += " show";
	document.querySelector(".menu-contextual-page-list").className += " no-grow";
}
